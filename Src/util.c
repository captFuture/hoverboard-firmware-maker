...
extern int32_t iOdomL,	iOdomR;		//ROBO defined and updated in bldc.c
...
uint16_t VirtAddVarTab[] = {1000, 1001, 1002, 1003, 1004, 1005, 1006, 1007, 1008, 1009,
                                     1010, 1011, 1012, 1013, 1014, 1015, 1016, 1017, 1018, 1019,
                                     1020, 1021, 1022};	// robo 1019..1022 added and NB_OF_VAR updated in eeprom.h 
#else
...
void Input_Init(void) {
    ...
    uint16_t j = 0;	// robo
    EE_ReadVariable(VirtAddVarTab[j++], &writeCheck);	// robo
    if (writeCheck == FLASH_WRITE_KEY) {
      #if defined(DEBUG_SERIAL_USART2) || defined(DEBUG_SERIAL_USART3)
        printf("Using the configuration from EEprom\r\n");
      #endif

      EE_ReadVariable(VirtAddVarTab[j++] , &readVal); rtP_Left.i_max = rtP_Right.i_max = (int16_t)readVal;	// robo
      EE_ReadVariable(VirtAddVarTab[j++] , &readVal); rtP_Left.n_max = rtP_Right.n_max = (int16_t)readVal;	// robo

      uint16_t uLow,uHigh;
      EE_ReadVariable(VirtAddVarTab[j++] , &uLow );		// robo
      EE_ReadVariable(VirtAddVarTab[j++] , &uHigh );	// robo
      iOdomL = ((int32_t)uHigh << 16) + uLow;
      EE_ReadVariable(VirtAddVarTab[j++] , &uLow );		// robo
      EE_ReadVariable(VirtAddVarTab[j++] , &uHigh );	// robo
      iOdomR = ((int32_t)uHigh << 16) + uLow;
      
      for (uint8_t i=0; i<INPUTS_NR; i++) {
        EE_ReadVariable(VirtAddVarTab[j++] , &readVal); input1[i].typ = (uint8_t)readVal;		// robo
        EE_ReadVariable(VirtAddVarTab[j++] , &readVal); input1[i].min = (int16_t)readVal;		// robo
        EE_ReadVariable(VirtAddVarTab[j++] , &readVal); input1[i].mid = (int16_t)readVal;		// robo
        EE_ReadVariable(VirtAddVarTab[j++] , &readVal); input1[i].max = (int16_t)readVal;		// robo
        EE_ReadVariable(VirtAddVarTab[j++] , &readVal); input2[i].typ = (uint8_t)readVal;		// robo
        EE_ReadVariable(VirtAddVarTab[j++] , &readVal); input2[i].min = (int16_t)readVal;		// robo
        EE_ReadVariable(VirtAddVarTab[j++] , &readVal); input2[i].mid = (int16_t)readVal;		// robo
        EE_ReadVariable(VirtAddVarTab[j++] , &readVal); input2[i].max = (int16_t)readVal;		// robo
...
void saveConfig() {
    ...
    if (inp_cal_valid || cur_spd_valid) {
      ...
      uint16_t j = 0;	// robo
      EE_WriteVariable(VirtAddVarTab[j++] , (uint16_t)FLASH_WRITE_KEY);	// robo
      EE_WriteVariable(VirtAddVarTab[j++] , (uint16_t)rtP_Left.i_max);	// robo
      EE_WriteVariable(VirtAddVarTab[j++] , (uint16_t)rtP_Left.n_max);	// robo
      EE_WriteVariable(VirtAddVarTab[j++] , (uint16_t)(iOdomL & 0xFFF) );	// robo
      EE_WriteVariable(VirtAddVarTab[j++] , (uint16_t)(iOdomL >> 16) );		// robo
      EE_WriteVariable(VirtAddVarTab[j++] , (uint16_t)(iOdomR & 0xFFF) );	// robo
      EE_WriteVariable(VirtAddVarTab[j++] , (uint16_t)(iOdomR >> 16) );		// robo
      
      for (uint8_t i=0; i<INPUTS_NR; i++) 
      {
        EE_WriteVariable(VirtAddVarTab[j++] , (uint16_t)input1[i].typ);	// robo
        EE_WriteVariable(VirtAddVarTab[j++] , (uint16_t)input1[i].min);	// robo
        EE_WriteVariable(VirtAddVarTab[j++] , (uint16_t)input1[i].mid);	// robo
        EE_WriteVariable(VirtAddVarTab[j++] , (uint16_t)input1[i].max);	// robo
        EE_WriteVariable(VirtAddVarTab[j++] , (uint16_t)input2[i].typ);	// robo
        EE_WriteVariable(VirtAddVarTab[j++] , (uint16_t)input2[i].min);	// robo
        EE_WriteVariable(VirtAddVarTab[j++] , (uint16_t)input2[i].mid);	// robo
        EE_WriteVariable(VirtAddVarTab[j++] , (uint16_t)input2[i].max);	// robo
      }
